...
<a href="javascript:crearLocation('{{ url('u/ubicaciones') }}')" class="btn btn-primary"><i class="fa fa-plus" aria-hidden="true"></i> Crear / Editar Aula</a>
...
<div class="row">
    <div class="col-md-12">
                    ...
                    <tbody>
                        ...
                        @foreach($locations as $location)
                            <tr>
                                ...
                                <td>{{ $location->floor->building->name ?? '—' }}</td>
                                <td>
        ...
        <div align="center">{!! $locations->appends(['name' => $name])->links() !!}</div>
    </div>
</div>
@stop
